      ...
      {!keys ? (
        <Stack spacing={3}>
          <Alert severity="info" sx={{ borderRadius: 2 }}>
            We'll generate a private key for you.{" "}
            <strong>Save it somewhere safe</strong> — it's the only way to
        ...
        <Stack spacing={3} sx={{ flex: 1 }}>
          <Alert
            ...
            sx={{ borderRadius: 2 }}
          >
            <strong>Save your private key now.</strong> It cannot be recovered
            if lost.
          </Alert>
          ...
          <Box
            sx={{
              ...
              p: 1.5,
              borderRadius: 2,
              border: `1px solid ${confirmed ? "#FF5722" : "#2A2A2A"}`,
          ...
          >
            <Checkbox
              ...
              icon={
                <RadioButtonUncheckedRoundedIcon sx={{ color: "text.secondary" }} />
              }
              checkedIcon={<CheckCircleRoundedIcon sx={{ color: "#FF5722" }} />}
